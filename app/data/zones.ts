export const ZONES = {
    "Johor": [
        ...
        { code: "JHR04", name: "Batu Pahat, Muar, Segamat, Tangkak" }
    ],
    "Kedah": [
        { code: "KDH01", name: "Kota Setar, Kubang Pasu, Pokok Sena (Daerah Kecil)" },
    ...
    "Kelantan": [
        ...
        { code: "KTN02", name: "Jeli, Gua Musang (Mukim Galas Dan Bertam), Jajahan Kecil Lojing" }
    ],
    "Melaka": [
    ...
    "Perak": [
        ...
        { code: "PRK02", name: "Kuala Kangsar, Sg. Siput (Daerah Kecil), Ipoh, Batu Gajah, Kampar" },
        { code: "PRK03", name: "Lenggong, Pengkalan Hulu, Grik" },
        { code: "PRK04", name: "Temengor, Belum" },
        { code: "PRK05", name: "Kp Gajah, Teluk Intan, Bagan Datuk, Seri Iskandar, Beruas, Parit, Lumut, Sitiawan, Pulau Pangkor" },
    ...
    "Sabah": [
        ...
        { code: "SBH04", name: "Bandar Tawau, Balung, Merotai, Kalabakan, Bahagian Tawau (Barat)" },
    ...
    "Sarawak": [
        ...
        { code: "SWK04", name: "Sibu, Mukah, Dalat, Oya, Balingian, Kanowit, Kapit, Song" },
        { code: "SWK05", name: "Sarikei, Matu, Julau, Rajang, Daro, Bintangor, Belawai" },
        { code: "SWK06", name: "Lubok Antu, Sri Aman, Roban, Debak, Kabong, Lingga, Engkilili, Betong, Spaoh, Pusa, Saratok" },
        { code: "SWK07", name: "Samarahan, Simunjan, Serian, Sebuyau, Meludam" },
